...
Route::prefix('borrows')->group(function () {
    ...
    Route::put('/{id}/update-status', [BorrowController::class, 'updateStatus'])->name('borrow.updateStatus'); // Thêm route này
    Route::get('/history/{reader_id}', [BorrowController::class, 'history'])->name('borrow.history'); // Thêm route này
});
